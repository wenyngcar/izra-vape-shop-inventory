import { post, get, deleteSingleProduct, deleteSales, put, patch } from "./helper-functions";
...
export async function deleteSaless(filter) {
    await deleteSales("delete-sales", filter)
}
