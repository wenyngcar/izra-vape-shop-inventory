...
function App() {
  return (
    ...
    <header className="bg-primary text-primary-foreground py-6">
      ...
      <Tabs defaultValue="account" className="flex-grow container mx-auto p-8 space-y-2 ">
        <TabsList className="bg-gray-100 w-full  grid-cols-2 justify-around">
          <TabsTrigger value="account"> <ListChecks className="w-4 h-4 mr-2" />Inventory</TabsTrigger>
          <TabsTrigger value="password"><ReceiptRussianRuble className="w-4 h-4 mr-2" />Sales</TabsTrigger>
        </TabsList>
        {/* For  inventory*/}
